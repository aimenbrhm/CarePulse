...
const registerUser = async (req, res) => {
    try {
        ...
        if (password.length < 8) {
            return res.json({ success: false, message: "enter a strong password ( 8 caracters minimum)" })
        }
...
// api to get user profile data (informations)
...
// Api to cancel an appointment ( annuler le rendez-vous)
